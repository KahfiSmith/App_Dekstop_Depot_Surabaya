...
import static depotsurabaya.Transaksi_Pesanan_Kry.txt_nota;
...
public class Pembayaran_pemesanan_Kry extends javax.swing.JFrame {

    static String username;
    public Pembayaran_pemesanan_Kry(String username) {
        initComponents();
        muncul();
        noedit();
        pnj();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pembayaran_pemesanan_Kry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
