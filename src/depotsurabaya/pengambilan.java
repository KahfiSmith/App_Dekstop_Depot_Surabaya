...
public class pengambilan extends javax.swing.JFrame {
    ...
    public pengambilan(String username) {
        initComponents();
        tampilnota();
    ...
    private void initComponents() {
        ...
        getContentPane().add(sudah, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 440, 120, -1));
        ...
        getContentPane().add(bayar, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 351, 150, 26));
        ...
        getContentPane().add(kurang, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 395, 150, 26));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 482, 120, 40));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 482, 130, 40));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 22, 40, 40));
        ...
        getContentPane().add(txt_bayar, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 350, 154, 29));

        txt_kembalian.setBorder(null);
        txt_kembalian.setOpaque(false);
        getContentPane().add(txt_kembalian, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 394, 153, 28));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pengambilan(Username).setVisible(true);
            }
        });
    }
